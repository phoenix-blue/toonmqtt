...
- maakt een backup van de relevante originele energieconfiguratie;
...
- dezelfde `folder` (`toonmqtt`) en versie (`1.2.0`) gebruikt als de
...
- Draai `scripts/check-release.sh 1.2.0`.
